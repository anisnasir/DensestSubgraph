...
plot "output_insertion_twitter_combined_modified.txt" title "processing time"
...
plot "output_deletion_twitter_combined_modified.txt" using 0:1 title "deletion time"
